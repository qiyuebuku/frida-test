...
使用示例：
    ...
    python process_chapters.py --mode markdown --input 清洗后目录 --output markdown目录 --min-agree 10
    python process_chapters.py --mode kb --input 清洗后目录 --output 知识库目录 --min-agree 15
    python process_chapters.py --mode json --input 原始目录 --output 清洗后目录 --test
"""
import argparse
import json
import os
