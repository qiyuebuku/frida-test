...
├── .claude/skills/smart-fund-server/     # rsync 同步的应用代码
├── config/
...
User=yuyangruan
Group=yuyangruan
WorkingDirectory=/home/yuyangruan/smart-fund/.claude/skills/smart-fund-server
...
- 代码目录 `/home/yuyangruan/smart-fund/.claude/skills/smart-fund-server`。
