...
RAG广泛应用于智能问答、文档摘要和知识辅助决策等场景，成为增强大语言模型事实性与可靠性的关键技术。
...
图片
3.5 效果
1. 问答质量有实质突破：整体准确率从56%提升至78%，其中知识召回率91%、TopK命中率90%、MRR 0.73；

2. 业务场景提效明显：AI检索较传统关键词检索的渗透率已到达30%左右，直接为数仓答疑环节节省20%以上时间成本，有效地减少了重复沟通与信息检索耗时。
4. 后续工作
