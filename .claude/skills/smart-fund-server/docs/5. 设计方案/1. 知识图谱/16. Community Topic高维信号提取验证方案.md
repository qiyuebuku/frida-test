...
- 明显非法标题只包括空标题、过长标题、带完整句式或标点的新闻标题、完全等于细尾词的标题、或以“动态 / 事件 / 项目 / 公告 / 概念 / 进展 / 目标 / 审批”等细尾词结尾的标题。系统不能因为标题包含某个字面片段就判定非法，例如“数据中心”不能因为包含“数据”被拒绝；但“单次行情数据”这类以普通“数据”收尾的细标题仍应拒绝。
