...
#define LOG_TAG "QDHook"
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)

static constexpr const char *TARGET_PKG = "com.qidian.QDReader";
...
static void companion_handler(int fd) {
    ...
    // Files are at: /data/adb/modules/qdhook_zygisk/dex/
    const char *dex_dir = "/data/adb/modules/qdhook_zygisk/dex";
