...
class TaskStreamClient(private val baseUrl: String) {
    ...
    fun connect(
        ...
        onToolCall: (display: String, detail: String, progress: Int, isText: Boolean, output: String) -> Unit,
        ...
        onMessageQueued: (content: String) -> Unit = {},
                    ...
                    try {
                        ...
                        withContext(Dispatchers.Main) {
                            when (type) {
                                ...
                                "message_queued" -> onMessageQueued(json.optString("content", ""))
                                "status_change" -> onStatusChange(json.optString("status", ""))
                                "done" -> {
