...
install -m 0755 "$SCRIPT_DIR/image/docker-entrypoint.sh" "$SCRIPT_DIR/image/ths-runtime-manager.sh" "$SCRIPT_DIR/image/ths-healthcheck.sh" "$SCRIPT_DIR/image/prepare-riru.sh" "$context/"
