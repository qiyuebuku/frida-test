...
git -C '$REMOTE_GIT_DIR' cat-file -e '$REVISION^{commit}'
git -C '$REMOTE_GIT_DIR' checkout --detach --force '$REVISION'
'$REMOTE_GIT_DIR/ths/deployment/redroid/rollout-production.sh' '$IMAGE' '$REVISION'"
