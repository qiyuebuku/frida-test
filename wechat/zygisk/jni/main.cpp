...
class WXHookModule : public zygisk::ModuleBase {
public:
    ...
    void postAppSpecialize(const zygisk::AppSpecializeArgs *args) override {
        ...
        jstring hookClassName = env->NewStringUTF("com.yuyang.wxhook.MainHook");
...
static void companion_handler(int fd) {
    const char *dex_dir = "/data/adb/modules/wxhook_zygisk/dex";
...
REGISTER_ZYGISK_MODULE(WXHookModule)
