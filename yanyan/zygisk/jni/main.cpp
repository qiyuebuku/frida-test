...
#define LOG_TAG "YYHook"
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)

static constexpr const char *TARGET_PKG = "com.zhihu.vip.android";
...
class YYHookModule : public zygisk::ModuleBase {
public:
    ...
    void postAppSpecialize(const zygisk::AppSpecializeArgs *args) override {
        ...
        jstring hookClassName = env->NewStringUTF("com.yuyang.yyhook.MainHook");
...
static void companion_handler(int fd) {
    ...
    // Files are at: /data/adb/modules/yyhook_zygisk/dex/
    const char *dex_dir = "/data/adb/modules/yyhook_zygisk/dex";
...
REGISTER_ZYGISK_MODULE(YYHookModule)
